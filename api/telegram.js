  ...
  try {
    ...
    if (text === '/start') {
      await tg(token, 'sendMessage', {
        chat_id: chatId,
        text: 'Готово 👌 Тут будуть приходити тільки нові заявки з сайту. Аналітику можна відкрити окремо через кнопку нижче.',
